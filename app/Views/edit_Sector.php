                        ...
                        <div class="col-12 grid-margin">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="<?= base_url('updateSector/' . $sector['idSector']); ?>"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" name="printOutput"
                                                            value="<?= $sector['PrintOutput']; ?>" required />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" name="TVSH"
                                                            value="<?= $sector['TVSH']; ?>" required />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
