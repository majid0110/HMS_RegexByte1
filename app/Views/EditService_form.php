                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" name="bcode"
                                                            value="<?= isset($service['BarCode']) ? $service['BarCode'] : ''; ?>" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                        ...
                                                        <select class="form-control" name="category">
                                                            <?php foreach ($categories as $category): ?>
                                                                <option value="<?= $category['idCatArt'] ?>"
                                                                    <?= ($service['idCatArt'] == $category['idCatArt']) ? 'selected' : '' ?>>
                                                                    <?= $category['name'] ?>
                                                                </option>
                                                            <?php endforeach; ?>
                                                        </select>
                                                        ...
                                                        <select class="form-control" name="unit">
                                                            <?php foreach ($units as $unit): ?>
                                                                <option value="<?= $unit['idUnit'] ?>"
                                                                    <?= ($service['idUnit'] == $unit['idUnit']) ? 'selected' : '' ?>>
                                                                    <?= $unit['name'] ?>
                                                                </option>
                                                            <?php endforeach; ?>
                                                        </select>
                                                        ...
                                                        <select class="form-control" name="tax">
                                                            <?php foreach ($tax as $taxes): ?>
                                                                <option value="<?= $taxes['tax_id'] ?>"
                                                                    <?= (isset($service['Tax']) && $service['Tax'] == $taxes['tax_id']) ? 'selected' : '' ?>>
                                                                    <?= $taxes['value'] ?>
                                                                </option>
                                                            <?php endforeach; ?>
                                                        </select>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select class="form-control" name="cstatus" required>
                                                            <option value="Active" <?= (isset($service['status']) && $service['status'] == 'Active') ? 'selected' : '' ?>>
                                                                Active</option>
                                                            <option value="Inactive" <?= (isset($service['status']) && $service['status'] == 'Inactive') ? 'selected' : '' ?>>
                                                                Inactive</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" name="char_1"
                                                            value="<?= isset($service['Characteristic1']) ? $service['Characteristic1'] : ''; ?>" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" name="char_2"
                                                            value="<?= isset($service['Characteristic2']) ? $service['Characteristic2'] : ''; ?>" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
