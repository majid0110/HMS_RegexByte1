            ...
            <div class="card-body">
              ...
              <div class="table-responsive">
                <table class="table table-striped">
                  ...
                  <tbody>
    <?php foreach ($businessData as $row) : ?>
        <tr>
            <td class="py-1"><img src="<?= base_url('uploads/' . $row['logo']) ?>" alt="image"></td>
            <td><?= $row['businessName'] ?></td>
            <td><?= $row['regName'] ?></td>
            <td><?= $row['businessType'] ?></td> <!-- Display business type name instead of ID -->
            <td><?= $row['address'] ?></td>
            <td><?= $row['phone'] ?></td>
            <td><?= $row['email'] ?></td>
            <td>
                <a href="<?= base_url('delete/' . $row['ID']) ?>" class="btn btn-danger">Delete</a>
                <a href="<?= base_url('edit/' . $row['ID']) ?>" class="btn btn-success">Edit</a>
            </td>
        </tr>
    <?php endforeach; ?>
</tbody>
