                        ...
                        <div class="col-12 grid-margin">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample" method="post" action="<?php echo base_url() . 'save_role'; ?>">
    <div class="form-group">
        <label for="exampleInputUsername1">Role Title</label>
        <input type="text" class="form-control" name="role_title" id="exampleInputUsername1" placeholder="">
    </div>
    <div class="form-group">
        <label for="exampleInputEmail1">Role Description</label>
        <input type="text" class="form-control" name="role_description" id="exampleInputUsername" placeholder="">
    </div>
    <div class="form-group">
        ...
        <tbody>
            <?php foreach ($moduleNames as $module) : ?>
                <tr>
                    <td>
                        <label>
                            <input type="checkbox" name="module_permissions[<?= $module['ID'] ?>][role]" value="<?= $module['module_name'] ?>"> <?= $module['module_name'] ?>
                        </label>
                    </td>
                    <td>
                        <label>
                            <input type="checkbox" name="module_permissions[<?= $module['ID'] ?>][view]" value="1"> View
                        </label>
                        <label>
                            <input type="checkbox" name="module_permissions[<?= $module['ID'] ?>][update]" value="1"> Update
                        </label>
                        <label>
                            <input type="checkbox" name="module_permissions[<?= $module['ID'] ?>][delete]" value="1"> Delete
                        </label>
                        <label>
                            <input type="checkbox" name="module_permissions[<?= $module['ID'] ?>][add]" value="1"> Add
                        </label>
                    </td>
                </tr>
            <?php endforeach; ?>
