...
<head>
    ...
    <link rel="stylesheet"
        href="<?= base_url('public/assets/vendors_s/select2-bootstrap-theme/select2-bootstrap.min.css') ?>">
                            ...
                            <table cellpadding="0" cellspacing="0">
                                <tr class="top">
                                    <td colspan="3">
                                        ...
                                        <span
                                            style=" font-family: fantasy;font-size: larger; color: <?= $ServiceDetails[0]['Notes'] === 'Cancelled' ? 'red' : 'green'; ?>">
                                            <?= $ServiceDetails[0]['Notes']; ?></span>




                                        <a href="<?= base_url('PurchaseController/cancelPurchaseInvoice/' . $ServiceDetails[0]['idReceipts']); ?>"
                                        ...
                                        <p>
                                            ...
                                            Created:
                                            <?= (new DateTime($ServiceDetails[0]['InvoiceDate']))->format('F d, Y'); ?><br />
                                        </p>
                                        ...
                                        <?php if ($ServiceDetails[0]['Status'] == 'open'): ?>
                                            ...
                                            <button type="button" style="margin-top: -3rem;margin-left: 89%;"
                                                ...
                                                data-target="#serviceDetailsModal">Pay</button>
                                        <?php endif; ?>
                                    </td>
                                </tr>
                                        ...
                                        <table>
                                            <tr>
                                                            ...
                                                            <tbody>
                                                                <?php if (!empty($referenceInvoices)): ?>
                                                                    <?php foreach ($referenceInvoices as $reference): ?>
                                                                        <tr>
                                                                            <td style="padding:0%;">Reference Invoice#<a
                                                                                    href="<?= base_url('viewServiceDetails/' . $reference['idReceipt']); ?>"
                                                ...
                                                <td>
                                                    ...
                                                    Supplier: <?= $ServiceDetails[0]['supplier']; ?><br />
                                                    Contact: <?= $ServiceDetails[0]['contact']; ?><br />
                                                    Address: <?= $ServiceDetails[0]['address']; ?><br />
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form class="pt-3" method="POST" action="<?= base_url('PurchasePayment') ?>"
                                                    ...
                                                    <div class="col">
                                                        ...
                                                        <div>
                                                            <input type="text" class="form-control" name="valueToPay"
                                                                value="<?= isset($valueToPay) ? $valueToPay : '' ?>"
                                                                readonly>
                                                        </div>
                                                    </div>
                                                    <div class="col">
                                                        <label>Value</label>
                                                        <div>
                                                            <input class="typeahead form-control" type="number"
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        ...
                                                        <div id="bloodhound">
                                                            <input class="typeahead form-control" type="number"
                                                                name="exchange" value='1.0' id="exchangeInput"
                                                                placeholder="Exchange Rate">
                                                        </div>
                                                    </div>
                                                    <div class="col">
                                                        <input type="hidden" name="client" class="form-control"
                                                            value="<?= isset($client) ? $client : '' ?>" readonly>
                                                    </div>
                                                </div>
                                                <input type="hidden" name="idReceipts"
                                                    value="<?= isset($idReceipts) ? $idReceipts : '' ?>">
    ...
    <div class="modal fade" id="correctModal" tabindex="-1" role="dialog" aria-labelledby="correctModalLabel"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="correctInvoiceForm" action="<?= base_url('PurchaseController/UpdatePurchaseInvoice'); ?>"
                        method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="client" name="client" required>
                                        <?php foreach ($clients as $client): ?>
                                            <option value="<?= $client['idSupplier']; ?>"
                                                <?= $client['idSupplier'] == $ServiceDetails[0]['idSupplier'] ? 'selected' : ''; ?>>
                                                <?= $client['supplier']; ?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="currency" name="currency" required>
                                        <?php foreach ($currencies as $currency): ?>
                                            <option value="<?= $currency['id']; ?>"
                                                <?= $currency['Currency'] == $ServiceDetails[0]['Currency'] ? 'selected' : ''; ?>>
                                                <?= $currency['Currency']; ?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="paymentMethod" name="paymentMethod" required>
                                        <?php foreach ($payments as $method): ?>
                                            <option value="<?= $method['idPaymentMethods']; ?>"
                                                <?= $method['Method'] == $ServiceDetails[0]['PaymentMethod'] ? 'selected' : ''; ?>>
                                                <?= $method['Method']; ?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="notes"
                                name="notes"><?= $ServiceDetails[0]['Notes']; ?></textarea>
                        </div>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <?php foreach ($ServiceDetails as $index => $detail): ?>
                                        <tr>
                                            <td>
                                                <input type="hidden" name="ServiceDetails[<?= $index; ?>][idItem]"
                                                    value="<?= $detail['idItem']; ?>">
