...
<body>
    <button class="btn btn-Dark" id="transferItemsBtn">Transfer Items</button>
    ...
    <div id="itemsModal" class="modal">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- Content for the dialog box will be loaded here -->
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        var btn = document.getElementById("transferItemsBtn");
        ...
        function loadItemsData() {
            ...
            xhr.open("GET", "<?php echo base_url('getItems'); ?>", true);
