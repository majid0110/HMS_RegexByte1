                    ...
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="card-title">Doctor Specialization</h4>
                                <button type="button" class="btn btn-primary"
                                    id="openSpecializationFormDialog">Add</button>
                                <hr>
                                ...
                                <div class="modal fade" id="specializationFormModal" tabindex="-1" role="dialog"
                                    aria-labelledby="specializationFormModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="specializationFormModalLabel">Specialization
                                                    Form</h5>
                                            ...
                                            <div class="modal-body" id="specializationFormModalBody">
                                                <?php include 'specialization_form.php'; ?>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        $(document).ready(function () {
            $('#openSpecializationFormDialog').click(function () {
                // Open dialog-box with specialization_form page
                $('#specializationFormModal').modal('show');
            });
        });
    </script>
