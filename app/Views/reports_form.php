                            ...
                            <div class="card" onclick="window.location.href='<?= base_url('appointment_report'); ?>';">
                                <div class="card-body">
                                    ...
                                    <div class="media">
                                        ...
                                        <svg style="margin: 0px auto" height="45px" width="45px" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                            ...
                            <div class="card" onclick="window.location.href='<?= base_url('lab_report'); ?>';">
                                <div class="card-body">
                                    ...
                                    <div class="media">
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" style="margin: 0px auto" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" width="45" height="45">
